...
<?php
 class index
 {
    ...
    public function get_baiviet($baiviet_id) {
        $query = "SELECT * FROM tbl_baiviet WHERE baiviet_id = '$baiviet_id' ORDER BY baiviet_id DESC";
        $result = $this -> db ->select($query);
        return $result;
    }
   ...
   public function getCurURL()
{
    ...
    $customer_tinh,$customer_huyen,$customer_xa,$customer_diachi,$email,$id_dangky) {
        $query = "SELECT * FROM tbl_order WHERE session_idA = '$session_idA' ORDER BY order_id DESC";
        $result = $this -> db ->select($query);
        if($result==null) {
            $query = "INSERT INTO tbl_order (session_idA,loaikhach,customer_name,customer_phone,customer_tinh,customer_huyen,customer_xa,customer_diachi,email,id_dangky) VALUES 
    ...
    public function insert_payment($session_idA,$deliver_method,$method_payment,$today,$email) {
        ...
        if($result==null) {
            ...
            $query = "INSERT INTO tbl_payment (session_idA,giaohang,thanhtoan,order_date,email) VALUES 
            ('$session_idA','$deliver_method','$method_payment','$today','$email')";
            $result = $this ->db ->insert($query);
