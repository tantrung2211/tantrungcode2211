...
if(isset($_POST['dangnhap']))
{
		...
		$matkhau = md5($_POST['matkhau']);
			...
			if($count>0)
			{
				...
				$_SESSION['dienthoai'] = $row_data['dienthoai'];
		


				header("Location:cart.php?id=live");
			}else{
				echo '<section class="cartegory">
        <img style="width: 50px; height: 50px; z-index: 3;" src="image/thatbai1.gif" alt="">
        <p style="color:red">Mật khẩu hoặc Email sai , vui lòng nhập lại</p>
        </section>';
  ...
  <div class="user_options-container">
    <div class="user_options-text">
      <div class="user_options-unregistered">
        <h2 class="user_unregistered-title">Chưa có tài khoản đăng nhập? </h2>
        <p class="user_unregistered-text">Hãy đăng ký ngay!</p>
        <button class="user_unregistered-signup" id="signup-button" ><a href="dangky.php" style="color: white;">Đăng ký ngay</a></button>
      </div>
