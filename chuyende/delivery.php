        ...
        ?>
             <div class="delivery-content row">
                 <div class="delivery-content-left">
                    ...
                    <p><span style="font-weight: bold;">Khách hàng</span></p>
                   <br>
                  <!--   <input style="float: left;margin-right:12px" class="register-input" name="loaikhach" value="dangky" type="radio">
                    ...
                    <div class="delivery-content-left-input-top row">
                        <div class="delivery-content-left-input-top-item">
                            ...
                            <input name="customer_name" oninvalid="this.setCustomValidity('Vui lòng không để trống')"
                             oninput="this.setCustomValidity('')" required type="text" value=" <?php
                                if(isset($_SESSION['dangky'])){echo $_SESSION['dangky'];
                                }
                                ?>">
                        </div>
                        <div class="delivery-content-left-input-top-item">
                    ...
                    <div class="delivery-content-left-input-bottom">
                            ...
                            <input readonly="False" name="email" oninvalid="this.setCustomValidity('Vui lòng không để trống')"
                             oninput="this.setCustomValidity('')" required  type="email" value="
                                          <?php
