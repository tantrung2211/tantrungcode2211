    ...
    <secsion class="top">
        <div class="container">
            <div class="row">
                ...
                <div class="top-logo">
                    <a href="index.php"><img src="image/logo10.png" style="width: 200px; height: 57px;" alt=""></a>
                </div>
                ...
                <div class="top-menu-icons">
                    <ul >
                        <li>
                             ...
                             <!-- <a style="width: 65px; color: black; font-family: var(--main-text-font); font-size: 12px;font-weight: bold;" href="tintuc.php">TIN TỨC</a> -->
                              <a style="width: 70px; color: black; font-family: var(--main-text-font); font-size: 12px;font-weight: bold;" href="lienhe.php">ABOUT US</a>
                           
                            
                             <form class="form-inline" action="timkiem.php" method="POST">
                                <input class="form-control mr-sm-2" name="search_product" type="search" placeholder="Tìm kiếm sản phẩm" aria-label="Search" required oninvalid="this.setCustomValidity('Vui lòng không để trống')"
                             oninput="this.setCustomValidity('')">
                                <button style="border-left-width: 0px;border-right-width: 0px;" class="btn my-2 my-sm-0" name="search_button" type="submit"><i class="fas fa-search" style="left: 230px;top: 20px;"></i></button>
                            </form>

                        </li>
                      <li>
                           <a style=" width: 110px; color: black; font-family: var(--main-text-font); font-size: 12px;font-weight: bold;"
                            href="kiemtradonhang.php">Kiểm tra đơn hàng</a><ion-icon name="bag-check-sharp"></ion-icon>
                      </li>
                        <li >
                        ...
                        <li>
                            ...
                            <div class="cart-content-mini">
                                ...
                                <div class="cart-content-mini-item">
                                    ...
                                    <h1>Giá: <?php echo number_format($result['sanpham_gia'])  ?> <sup>đ</sup></h1> 
                                    </div>
                                </div>
                                    <?php
                          ...
                          <li style=" color: black; font-family: var(--main-text-font); font-size: 14px;font-weight: bold;"><ion-icon name="call-sharp"></ion-icon>HOTLINE:0987654321</i>  </li>
