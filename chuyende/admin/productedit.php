 ...
 <div class="admin-content-right">
            <div class="product-add-content">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <select required="required" name="loaisanpham_id" id="">
                         <option value="">--Chọn--</option>
                        <?php
                    ...
                    <input type="number" value="<?php echo $resul['sanpham_gia'] ?>" required type="text" name="sanpham_gia"> <br>
                     <label  for="">Số lượng sản phẩm <span style="color: red;">*</span></label> <br>
                    <input type="number" value="<?php echo $resul['soluong'] ?>" required type="text" name="soluong"> <br>  
                     <label for="">Sản phẩm bán chạy hay bình thường<span style="color: red;">*</span></label> <br>
                        
                     <select required="required" name="sanpham_hot">
                        <option value="">--Chọn--</option>
                        
                        <option name="sanpham_hot" value="0" selected >Thường</option>
                    ...
                    <button class="admin-btn" name="submit" type="submit">Sửa Thông tin</button>  
                </form>
            </div>           
        </div>
    </section>
