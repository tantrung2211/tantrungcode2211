...
class brand
{
 ...
 public function insert_baiviet($tenbaiviet,$noidung,$ngaydang,$anhbaiviet) {
    $query = "INSERT INTO tbl_baiviet (tenbaiviet,noidung,ngaydang,anhbaiviet) VALUES
     ('$tenbaiviet','$noidung','$ngaydang','$anhbaiviet')";
    $result = $this ->db ->insert($query);
   ...
   public function show_user(){
    $query = "SELECT * FROM tbl_dangky ORDER BY id_dangky DESC";
    $result = $this -> db ->select($query);
    return $result;  
   }
   ...
   public function get_color($color_id){
    ...
    public function get_baiviet($baiviet_id){
        $query = "SELECT * FROM tbl_baiviet WHERE baiviet_id = '$baiviet_id'";
        $result = $this -> db ->select($query);
        return $result;
   }
   ...
   public function update_color($color_ten,$color_anh,$color_id){
            ...
            SET color_ten = '$color_ten', color_anh = '$color_anh' WHERE color_id = '$color_id'";
            $result = $this ->db ->update($query);
            echo "<script> window.location.href='colorlist.php';</script>";
            // header('Location:colorlist.php');
            return $result;
   ...
   public function update_baiviet($tenbaiviet,$noidung,$ngaydang,$anhbaiviet,$baiviet_id){
            $query = "UPDATE tbl_baiviet 
            SET tenbaiviet = '$tenbaiviet',ngaydang = '$ngaydang' ,noidung = '$noidung', anhbaiviet = '$anhbaiviet'  
   ...
   public function delete_baiviet($baiviet_id){
    $query = "DELETE  FROM tbl_baiviet WHERE baiviet_id = '$baiviet_id'";
    $result = $this -> db ->delete($query);
    return $result; 
  }
