...
?>
        ...
        <h1 style="color:#333">Các đơn hàng đang giao</h1>
                <br>
            <div class="table-content">
                ...
                ?>
                    <tr>
                        ...
                        <td><a style="color:tomato" href="?status=2&session_idA=<?php echo $result['session_idA'] ?>"  
                            onclick="return confirm('Đơn hàng này sẽ chuyển sang trạng thái giao hàng thành công ?');">Đang giao hàng..</a></td>
                        <td><a href="orderdelete.php?session_idA=<?php echo $result['session_idA'] ?>" onclick="return confirm('Đơn hàng sẽ bị xóa vĩnh viễn, bạn có chắc muốn tiếp tục không?');"><ion-icon name="trash-outline"></ion-icon></a></td>
                    </tr>
                    <?php
                     }}
                  ?>
